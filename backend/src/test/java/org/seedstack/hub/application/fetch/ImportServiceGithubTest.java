...
public class ImportServiceGithubTest {
    ...
    @Tested
    private ImportServiceGithub underTest;
    @Injectable
    ...
    public void importComponent() throws Exception {
        ...
        Component component = underTest.importComponent(new Source(VCSType.GITHUB, "seedstack/mongodb-addon"));

        new Verifications() {{
           componentRepository.persist(withNotNull()); times = 1;
            documentRepository.persist(withNotNull()); times = 2;
        }};
