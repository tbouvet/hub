...
class HubProxySelector extends ProxySelector {
    private final ProxySelector defaultProxySelector;
    private final List<Pattern> exclusions;
    private final Proxy httpProxy;
    private final Proxy httpsProxy;

    public HubProxySelector(Proxy httpProxy, Proxy httpsProxy, ProxySelector defaultProxySelector, List<Pattern> exclusions) {
